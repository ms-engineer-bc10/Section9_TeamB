...
def generate_story(child, telling_record):
    ...
    response = openai.ChatCompletion.create(
        model="gpt-3.5-turbo",
        messages=[
            {"role": "system", "content": "You are a Japanese children's picturebook author specializing in personalized stories that gently address sensitive family backgrounds."},
