...
export default function HomePage() {
  const features = [
    ...
    {
      title: "成長に合わせたストーリー",
      desc: "お子さまの年齢や興味に合わせていつでも作り直すことができます",
  ...
  const faqs = [
    {
      question: "どんな年齢の子供向けですか？",
      answer:
        "主に1〜6歳のお子様向けですが、年齢に合わせたストーリーを提供しています。",
    },
    {
      question: "絵本の作成にどのくらい時間がかかりますか？",
      answer:
        "入力時間を含めて10〜20分程度で作成できます。より詳細なカスタマイズを行う場合は、さらに時間がかかる場合があります。",
    },
    {
      question: "作成した絵本を実際に印刷することはできますか？",
      answer:
        "はい、PDFでダウンロードしてご自宅で印刷できます。また、高品質印刷サービスも準備中です。",
    },
  ];
  ...
  return (
    <>
      ...
      >
        ...
        <section
          id="storytelling"
          className="py-16 bg-[#E0F2F1] rounded-3xl mx-4 mt-8"
        >
          <div className="container mx-auto px-4">
            <h2
              className="text-3xl font-bold text-center text-[#4CAF50] mb-10"
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              ...
              <p className="text-[#444444] mb-6 text-center">
                真実告知とは、子どもが出自（自分のルーツ）や生い立ちを知る権利を保障し、アイデンティティを確立するために欠かせない行為です。
              </p>
              <div className="bg-[#FFF3E0] p-6 rounded-lg mb-6">
                <p className="text-[#8D6E63] italic text-center">
                  「私は、あなたの遺伝的な親ではない」と、言うことではありません。
                  <br />
                  実親（遺伝的な親）が別にいるという出生の事実を伝えるとともに、お子さまが来てくれることを心から望んでいたら家族に迎えることができた」
                </p>
              </div>
              <p className="text-[#444444] mb-6 text-center">
                という
              ...
              <div className="border-t-2 border-b-2 border-[#4CAF50] py-4">
                <p className="text-[#4CAF50] font-semibold text-center">
                  養子縁組など様々なルーツを持つご家族に向けて真実告知のハードルを下げ、日々の中で自然に伝えることができるよう絵本を通じてお手伝いできることが私たちのねがいです。
                </p>
              </div>
            </div>
          </div>
        ...
        <section
          id="advice"
          className="py-16 bg-[#FFDAB9] rounded-3xl mx-4 mt-8"
        >
          <div className="container mx-auto px-4">
            <h2
              className="text-3xl font-bold text-center mb-12 text-[#FF8C00]"
            ...
            <div className="bg-white p-8 rounded-3xl shadow-lg text-center">
              ...
              <ul className="list-none p-0 mt-6 space-y-2">
                <li className="text-[#444444] text-lg font-bold">
                  👶 乳幼児期のコミュニケーション方法
                </li>
                <li className="text-[#444444] text-lg font-bold">
                  🧒 学童期の自尊心の育て方
        ...
        <section
          id="contact"
          className="py-12 bg-[#E0F2F1] rounded-3xl mx-4 mt-8"
        >
          <div className="container mx-auto px-4 max-w-md">
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-[#4CAF50] text-white py-2 rounded-full hover:bg-[#45a049] transition-colors"
              >
                送信する
              </button>
            </form>
